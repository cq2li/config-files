...
" In insert mode, press shift tab to unindent
inoremap <S-Tab> <C-D>
...
" Map ctrl j key stroke to esc in insert mode
inoremap <C-J> <esc>
vnoremap <C-J> <esc>

" Mapping > to retain line selection after shifting
vnoremap > >gv
vnoremap < <gv
"------------------------------------------------------------
...
" Set column colour at 80 characters
set colorcolumn=80
...
" Enable auto jumping to matched words as search string is typed 
set incsearch


" https://jeffkreeftmeijer.com/vim-number/
"  both absolute and relative line numbers are enabled by default, which 
"  produces “hybrid” line numbers. When entering insert mode, relative line 
